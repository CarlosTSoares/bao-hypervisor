...
struct smmuv3_hw {
    ...
    volatile struct smmuv3_ste* st;
    volatile struct smmuv3_eventq_entry* eventq;
};
...
static void smmuv3_check_capabilities()
{
    ...
    console_printk("[BAO-SMMUV3] Beginnig of check capabilities\n");
    ...
    console_printk("[BAO-SMMUV3] After major version extract\n");
    ...
    console_printk("[BAO-SMMUV3] After stage-2 support\n");
...
void smmuv3_init()
{
    ...
    console_printk("[BAO-SMMUV3] Base addr of regmap_p0 is 0x%lx,"
        "physical value is 0x%x and page number is %d\n",smmuv3.hw.regmap_p0,platform.arch.smmu.base,NUM_PAGES(sizeof(struct smmuv3_regmap_p0_hw)));
    ...
    console_printk("[BAO-SMMUV3] Base addr of regmap_p1 is 0x%lx\n",smmuv3.hw.regmap_p1);

    // # Check capabilities
    smmuv3_check_capabilities();
    console_printk("[BAO-SMMUV3] Capabilities verified\n");

    // # Clear Errors/Interrupts
    smmuv3.hw.regmap_p0->GERROR_N = smmuv3.hw.regmap_p0->GERROR;

    console_printk("[BAO-SMMUV3] Clear Errors\n");
    // TODO: Wired-signaled interrupt mechanism is implementation-defined. Check for MSI support and
